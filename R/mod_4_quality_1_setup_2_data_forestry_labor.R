...
mod_4_quality_1_setup_2_data_forestry_labor_server <- function(id, parent, r6){
  moduleServer(id, function(input, output, session){
    ...
    input_choices <- shiny::reactiveValues(
      hhold_dfs = r6$forestry_labor_hhold_df_choices,
      ...
      labor_vals = r6$forestry_labor_labor_vals
    )
    ...
    if (!is.null(r6$livestock_labor_provided)) {
      ...
      input_specs <- tibble::tribble(
        ...
        # hhold data
        "hhold_df",           updateSelectInput,    list(
          choices = r6$forestry_labor_hhold_df_choices,
        ...
        "hhold_labor_val",   updateSelectInput,    list(
          choices = r6$forestry_labor_labor_choices,
    ...
    shiny::observeEvent(input$save, {
      ...
      r6$forestry_labor_hhold_df <- input$data
      # forestry production variable
