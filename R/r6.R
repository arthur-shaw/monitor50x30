...
r6 <- R6::R6Class(
  ...
  public = list(
    ...
    perm_crop_harvest_produce_var_choices = NULL,
    perm_crop_harvest_produce_var = NULL,
    ...
    cow_displacement_animal_var_choices = NULL,
    cow_displacement_animal_var = NULL,
    cow_displacement_val_choices = NULL,
    cow_displacement_bull_val = NULL,
    ...
    livestock_labor_anim_var_choices = NULL,
    livestock_labor_anim_var = NULL,
    ...
    # income_sources
    income_sources_hhold_df_choices = NULL,
    income_sources_hhold_df = NULL,
    income_sources_crop_var_choices = NULL,
    income_sources_crop_var = NULL,
    income_sources_crop_val_choices = NULL,
    income_sources_crop_val = NULL,
    income_sources_livestock_var_choices = NULL,
    income_sources_livestock_var = NULL,
    income_sources_livestock_val_choices = NULL,
    income_sources_livestock_val = NULL,
    income_sources_temp_crop_df_choices = NULL,
    income_sources_temp_crop_df = NULL,
    income_sources_temp_crop_var_choices = NULL,
    income_sources_temp_crop_var = NULL,
    income_sources_temp_crop_vals = NULL,
    income_sources_temp_crop_val = NULL,
    income_sources_perm_crop_df_choices = NULL,
    income_sources_perm_crop_df = NULL,
    income_sources_perm_crop_var_choices = NULL,
    income_sources_perm_crop_var = NULL,
    income_sources_perm_crop_vals = NULL,
    income_sources_perm_crop_val = NULL,
    income_sources_processed_df_choices = NULL,
    income_sources_processed_df = NULL,
    income_sources_processed_var_choices = NULL,
    income_sources_processed_var = NULL,
    income_sources_processed_vals = NULL,
    income_sources_processed_val = NULL,
    income_sources_anim_df_choices = NULL,
    income_sources_anim_df = NULL,
    income_sources_sold_live_anim_var_choices = NULL,
    income_sources_sold_live_anim_var = NULL,
    income_sources_slaughter_anim_var_choices = NULL,
    income_sources_slaughter_anim_var = NULL,
    income_sources_slaughter_anim_val_choices = NULL,
    income_sources_slaughter_anim_val = NULL,
    income_sources_sold_live_poultry_var_choices = NULL,
    income_sources_sold_live_poultry_var = NULL,
    income_sources_slaughter_poultry_var_choices = NULL,
    income_sources_slaughter_poultry_var = NULL,
    income_sources_slaughter_poultry_val_choices = NULL,
    income_sources_slaughter_poultry_val = NULL,
    income_sources_milk_var_choices = NULL,
    income_sources_milk_var = NULL,
    income_sources_milk_val_choices = NULL,
    income_sources_milk_val = NULL,
    income_sources_eggs_var_choices = NULL,
    ...
    write = function(
      ...
      vctr_fields <- c(
        ...
        "perm_crop_harvest_produce_var_choices",
        ...
        "livestock_labor_anim_var_choices",
        ...
        # income_sources
        "income_sources_hhold_df_choices",
        "income_sources_crop_var_choices",
        "income_sources_crop_val_choices",
        "income_sources_livestock_var_choices",
        "income_sources_livestock_val_choices",
        "income_sources_temp_crop_df_choices",
        "income_sources_temp_crop_var_choices",
        "income_sources_temp_crop_vals",
        "income_sources_perm_crop_df_choices",
        "income_sources_perm_crop_var_choices",
        "income_sources_perm_crop_vals",
        "income_sources_processed_df_choices",
        "income_sources_processed_var_choices",
        "income_sources_processed_vals",
        "income_sources_anim_df_choices",
        "income_sources_sold_live_anim_var_choices",
        "income_sources_slaughter_anim_var_choices",
        "income_sources_slaughter_anim_val_choices",
        "income_sources_sold_live_poultry_var_choices",
        "income_sources_slaughter_poultry_var_choices",
        "income_sources_slaughter_poultry_val_choices",
