...
r6 <- R6::R6Class(
  ...
  public = list(
    ...
    icome_sources_crop_var_choices = NULL,
    icome_sources_crop_var = NULL,
    icome_sources_crop_val_choices = NULL,
    icome_sources_crop_val = NULL,
    ...
    write = function(
      ...
      vctr_fields <- c(
        ...
        "icome_sources_crop_var_choices",
        "icome_sources_crop_val_choices",
