  ...
  tagList(
    ...
    bslib::accordion(
      ...
      bslib::accordion_panel(
        ...
        mod_4_quality_1_setup_2_data_livestock_labor_ui(
          id = ns("4_quality_1_setup_2_data_livestock_labor_1")
        )
      ),
      bslib::accordion_panel(
      ...
      bslib::accordion_panel(
        ...
        mod_4_quality_1_setup_2_data_aquaculture_labor_ui(
          id = ns("4_quality_1_setup_2_data_aquaculture_labor_1")
        )
      ),
      bslib::accordion_panel(
        title = "Forestry labor",
        value = "forestry_labor",
        mod_4_quality_1_setup_2_data_forestry_labor_ui(
          id = ns("4_quality_1_setup_2_data_forestry_labor_1")
        )
      ),
      bslib::accordion_panel(
...
mod_4_quality_1_setup_2_data_server <- function(id, parent, r6){
  moduleServer(id, function(input, output, session){
    ...
    mod_4_quality_1_setup_2_data_aquaculture_labor_server(
      id = "4_quality_1_setup_2_data_aquaculture_labor_1",
      parent = session,
      r6 = r6
    )
