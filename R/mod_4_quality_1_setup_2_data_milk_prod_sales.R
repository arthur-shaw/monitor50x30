...
mod_4_quality_1_setup_2_data_milk_prod_sales_ui <- function(id) {
  ...
  tagList(
    ...
    shiny::selectInput(
      ...
      label = label_tooltip(
        lbl = "Value(s): Milk-producing livestock.",
    ...
    shiny::selectInput(
      ...
      label = label_tooltip(
        lbl = "Question: Whether produced milk",
        desc = paste(
          "Typically, the first question in the MILK PRODUCTION section.",
          "Often, 'milk any' appears in the question text.",
    ...
    shiny::selectInput(
      ...
      label = label_tooltip(
        lbl = "Question(s): value of milk sales.",
        desc = paste(
...
mod_4_quality_1_setup_2_data_milk_prod_sales_server <- function(id, r6, parent){
  moduleServer(id, function(input, output, session){
    ...
    # --------------------------------------------------------------------------
    # when values have not been previously saved
    # --------------------------------------------------------------------------
