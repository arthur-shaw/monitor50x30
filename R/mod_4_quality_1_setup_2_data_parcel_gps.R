#' 4_quality_1_setup_2_data_parcel_gps UI Function
#'
...
mod_4_quality_1_setup_2_data_parcel_gps_ui <- function(id) {
  ns <- NS(id)
  tagList(
...
#' 4_quality_1_setup_2_data_parcel_gps Server Functions
#'
#' @noRd 
mod_4_quality_1_setup_2_data_parcel_gps_server <- function(id, parent, r6){
  moduleServer(id, function(input, output, session){
    ...
    input_choices <- shiny::reactiveValues(
      data = r6$parcel_gps_df_choices,
      gps_var = r6$parcel_gps_gps_var_choices,
      not_measured_val = r6$parcel_gps_not_measured_val_choices,
      why_not_measured_var = r6$parcel_gps_why_not_measured_var_choices
    )
    ...
    if (!is.null(r6$parcel_gps_provided)) {
      ...
      shiny::updateSelectInput(
        inputId = "data",
        choice = r6$parcel_gps_df_choices,
        selected = r6$parcel_gps_df
      )
      ...
      shiny::updateSelectInput(
        inputId = "gps_var",
        choice = r6$parcel_gps_gps_var_choices,
        selected = r6$parcel_gps_gps_var
      )
      ...
      shiny::updateSelectInput(
        inputId = "why_not_measured_var",
        choice = r6$parcel_gps_why_not_measured_var_choices,
        selected = r6$parcel_gps_why_not_measured_var
      )
        ...
        value_label <- shiny::reactive(
          ...
          dplyr::if_else(
            ...
            true = glue::glue_collapse(
              x = c(
                "Value of the question indicating the parcel was not measured.",
    ...
    shiny::observeEvent(input$save, {
      ...
      # data
      r6$parcel_gps_df_choices <- input_choices$data
      r6$parcel_gps_df <- input$data
      # GPS measurement variable
      r6$parcel_gps_gps_var_choices <- input_choices$gps_var
      r6$parcel_gps_gps_var <- input$gps_var
      # not measured values
      r6$parcel_gps_not_measured_val_choices <- as.character(
        input_choices$not_measured_val
      )
      r6$parcel_gps_not_measured_val <- as.character(
        input$not_measured_val
      )
      # why not measured variable
      r6$parcel_gps_why_not_measured_var_choices <-
        input_choices$why_not_measured_var
      r6$parcel_gps_why_not_measured_var <- input$why_not_measured_var
      # save action
      r6$parcel_gps_provided <- TRUE

      # write R6 to disk
      r6$write()

      # send signal that info provided
      gargoyle::trigger("saved_parcel_gps")
...
# mod_4_quality_1_setup_2_data_parcel_gps_ui("4_quality_1_setup_2_data_parcel_gps_1")

## To be copied in the server
# mod_4_quality_1_setup_2_data_parcel_gps_server("4_quality_1_setup_2_data_parcel_gps_1")
