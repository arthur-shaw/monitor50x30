  ...
  shiny::tagList(
    ...
    bslib::accordion(
      ...
      bslib::accordion_panel(
        ...
        mod_3_complete_1_setup_2_clusters_3_manager_id_3_compose_ui(
          ns("3_complete_1_setup_2_clusters_3_manager_id_3_compose_1")
        )
      )
    )
...
mod_3_complete_1_setup_2_clusters_3_manager_id_server <- function(id, parent, r6){
  moduleServer( id, function(input, output, session){
    ...
    mod_3_complete_1_setup_2_clusters_3_manager_id_3_compose_server(
      id = "3_complete_1_setup_2_clusters_3_manager_id_3_compose_1",
      parent = session,
      r6 = r6
    )
