#' 4_quality_1_setup_2_data_aquaculture_prod_sales UI Function
#'
...
mod_4_quality_1_setup_2_data_aquaculture_prod_sales_ui <- function(id) {
  ns <- NS(id)
  tagList(
...
#' 4_quality_1_setup_2_data_aquaculture_prod_sales Server Functions
#'
#' @noRd 
mod_4_quality_1_setup_2_data_aquaculture_prod_sales_server <- function(id, parent, r6){
  moduleServer(id, function(input, output, session){
    ...
    if (!is.null(r6$aquaculture_prod_provided)) {
      ...
      input_specs <- tibble::tribble(
        ...
        "products_var",   updateSelectInput,    list(
          choices = r6$aquaculture_prod_products_var_choices,
        ...
        "sold_var",       updateSelectInput,    list(
          choices = r6$aquaculture_prod_sold_var_choices,
          selected = r6$aquaculture_prod_sold_var
        ),
        "sold_val",       updateSelectInput,    list(
          choices = r6$aquaculture_prod_sold_val_choices,
          selected = r6$aquaculture_prod_sold_val
        ),
        "amt_sold_vars",  updateSelectInput,    list(
          choices = r6$aquaculture_prod_amt_sold_var_choices,
          selected = r6$aquaculture_prod_amt_sold_var
        ),
        "amt_sold_dk_val", updateNumericInput,  list(
          value = r6$aquaculture_prod_amt_sold_dk_val
        )
    ...
    shiny::observeEvent(input$save, {
      ...
      # household data
      r6$aquaculture_prod_hhold_df_choices <- input_choices$hhold_dfs
      r6$aquaculture_prod_hhold_df <- input$hhold_df
      # practiced aquaculture variables
      r6$aquaculture_prod_practice_var_choices <- input_choices$practice_vars
      r6$aquaculture_prod_practice_var <- input$practice_var
      # practiced aquaculture value
      r6$aquaculture_prod_practice_val_choices <- input_choices$practice_vals
      r6$aquaculture_prod_practice_val <- input$practice_val
      # aquaculture products variable
      r6$aquaculture_prod_products_var_choices <- input_choices$products_vars
      r6$aquaculture_prod_products_var <- input$products_var
      # products data
      r6$aquaculture_prod_product_df_choices <- input_choices$product_dfs
      r6$aquaculture_prod_product_df <- input$product_df
      # sold variable
      r6$aquaculture_prod_sold_var_choices <- input_choices$sold_vars
      r6$aquaculture_prod_sold_var <- input$sold_var
      # sold value
      r6$aquaculture_prod_sold_val_choices <- input_choices$sold_vals
      r6$aquaculture_prod_sold_val <- input$sold_val
      # amount sold variables
      r6$aquaculture_prod_amt_sold_var_choices <- input_choices$amt_sold_vars
      r6$aquaculture_prod_amt_sold_var <- input$amt_sold_vars
      # amount sold DK value
      r6$aquaculture_prod_amt_sold_dk_val <- input$amt_sold_dk_val
      # save action
      r6$aquaculture_prod_provided <- TRUE

      # write R6 to disk
      r6$write()

      # send signal that info provided
      gargoyle::trigger("saved_aquaculture_prod_sales")
...
# mod_4_quality_1_setup_2_data_aquaculture_prod_sales_ui("4_quality_1_setup_2_data_aquaculture_prod_sales_1")
    
## To be copied in the server
# mod_4_quality_1_setup_2_data_aquaculture_prod_sales_server("4_quality_1_setup_2_data_aquaculture_prod_sales_1")
