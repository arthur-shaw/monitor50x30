...
app_server <- function(input, output, session) {
  ...
  gargoyle::init("saved_plot_use")
  gargoyle::init("saved_plot_gps")
  gargoyle::init("saved_crops_per_plot")
  gargoyle::init("saved_crop_types")
  gargoyle::init("saved_temp_crop_harvest")
  gargoyle::init("saved_temp_crop_sales")
  ...
  gargoyle::init("saved_hen_displacement")
  gargoyle::init("saved_milk_prod_sales")
  gargoyle::init("saved_egg_prod_sales")
  gargoyle::init("saved_fisheries_prod_sales")
  gargoyle::init("saved_aquaculture_prod_sales")
  gargoyle::init("saved_forestry_prod_sales")
  gargoyle::init("saved_process_crop_prod_sales")
  gargoyle::init("saved_crop_labor_sales")
  gargoyle::init("saved_livestock_labor_sales")
  gargoyle::init("saved_fisheries_labor_sales")
  gargoyle::init("saved_aquaculture_labor_sales")
  gargoyle::init("saved_forestry_labor_sales")
  gargoyle::init("saved_income_sources_sales")
