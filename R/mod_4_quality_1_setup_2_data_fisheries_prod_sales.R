...
mod_4_quality_1_setup_2_data_fisheries_prod_sales_ui <- function(id) {
  ...
  tagList(
    ...
    shiny::selectInput(
      ...
      label = label_tooltip(
        ...
        desc = paste(
          ...
          "Frequently, this is the first question in the 'FISHING PRODUCTION'",
          "section."
        )
      ),
      choices = NULL,
    ...
    shiny::selectInput(
      ...
      label = label_tooltip(
        lbl = "Question: Which fishing products caught.",
        desc = paste(
          "The question that indicates, yes or no,",
          "which fisheries products are caught from a list.",
          "The question text contains 'catch'.",
    ...
    shiny::selectInput(
      ...
      label = label_tooltip(
        lbl = "Data: Fishing production",
        desc = paste(
          "Data set with one observation per fishing product",
    ...
    shiny::selectInput(
      inputId = ns("sold_var"),
      label = label_tooltip(
        lbl = "Question: Whether sold fishing production.",
        desc = paste(
          "Typically, 'sell' and 'fished' are in the question text",
          "Type that to narrow the list of candidate questions."
        )
      ),
      choices = NULL,
    ...
    shiny::selectInput(
      inputId = ns("sold_val"),
      label = label_tooltip(
        lbl = "Value: Sold fishing production",
        desc = "Typically, the value is 1 for 'Yes'."
      ),
      choices = NULL,
      selected = NULL
    ...
    shiny::selectInput(
      ...
      label = label_tooltip(
        lbl = "Question(s): Amount of fishing production sold.",
        desc = paste(
