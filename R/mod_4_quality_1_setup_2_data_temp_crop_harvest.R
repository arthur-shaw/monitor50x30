#' 4_quality_1_setup_2_data_temp_crop_harvest UI Function
#'
...
mod_4_quality_1_setup_2_data_temp_crop_harvest_ui <- function(id) {
  ns <- NS(id)
  tagList(
...
#' 4_quality_1_setup_2_data_temp_crop_harvest Server Functions
#'
#' @noRd 
mod_4_quality_1_setup_2_data_temp_crop_harvest_server <- function(id, parent, r6){
  moduleServer(id, function(input, output, session){
    ...
    input_choices <- shiny::reactiveValues(
      data = r6$temp_crop_harvest_df_choices,
    ...
    if (!is.null(r6$temp_crop_harvest_provided)) {
      ...
      shiny::req(
        r6$temp_crop_harvest_df_choices, r6$temp_crop_harvest_df,
        r6$temp_crop_harvest_crop_id_var_choices,
        r6$temp_crop_harvest_crop_id_var,
        r6$temp_crop_harvest_crop_vals_choices, r6$temp_crop_harvest_crop_vals,
        r6$temp_crop_harvest_harvest_var_choices,
        r6$temp_crop_harvest_harvest_var,
        r6$temp_crop_harvest_harvest_val_choices,
        r6$temp_crop_harvest_harvest_val,
        r6$temp_crop_harvest_why_not_harvest_var_choices,
        r6$temp_crop_harvest_why_not_harvest_var,
        r6$temp_crop_harvest_provided
      )
      ...
      shiny::updateSelectInput(
        inputId = "data",
        choice = r6$temp_crop_harvest_df_choices,
        selected = r6$temp_crop_harvest_df
      )
    ...
    shiny::observeEvent(input$save, {
      ...
      r6$temp_crop_harvest_crop_vals <- input$crop_vals
      # harvest variable
      r6$temp_crop_harvest_harvest_var_choices <- input_choices$harvest_var
      r6$temp_crop_harvest_harvest_var <- input$harvest_var
      # harvest value
      r6$temp_crop_harvest_harvest_val_choices <- input_choices$harvest_var_vals
      r6$temp_crop_harvest_harvest_val <- input$harvest_val
      # why not harvest variable
      r6$temp_crop_harvest_why_not_harvest_var_choices <-
      ...
      gargoyle::trigger("saved_temp_crop_harvest")
...
# mod_4_quality_1_setup_2_data_temp_crop_harvest_ui("4_quality_1_setup_2_data_temp_crop_harvest_1")
    
## To be copied in the server
# mod_4_quality_1_setup_2_data_temp_crop_harvest_server("4_quality_1_setup_2_data_temp_crop_harvest_1")
